...
const JogosFav = () => {
    ...
    useEffect(() => {
        axios.get("https://projeto-2-backend-gaabridjan-1.onrender.com/api/games/")
    ...
    const deleteGame = async (id) => {
        try {
            await axios.delete(`https://projeto-2-backend-gaabridjan-1.onrender.com/api/games/${id}/`);
